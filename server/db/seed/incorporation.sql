...
INSERT INTO StockTransactions (id, type, shares, date)
VALUES (1, 'CREATE', 10000000, '2024-01-01');

-- Initial account statement for company incorporation
INSERT INTO CompanyCapitalization (stock_transaction_id, unissued_shares)
VALUES (1, 10000000);
...
INSERT INTO StockTransactions (id, account_uuid, type, shares, date) VALUES 
...
INSERT INTO CompanyCapitalization (stock_transaction_id, outstanding_shares, unissued_shares) VALUES 
(2, 4000000, 6000000),
(3, 3000000, 3000000),
(4, 1000000, 2000000); 

-- Initial account statements for founders
INSERT INTO AccountStatements (account_uuid, shares, date) VALUES 
